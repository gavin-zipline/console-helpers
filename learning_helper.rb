...
📘 Learning Helper Cheatsheet:"
  ...
  puts "♻️  resync_track_enrollments(track)      # Re-run the TrackSync job to sync enrollments"
  puts
end

alias learning_helper_cheatsheet learning_cheatsheet
alias learnings_cheatsheet learning_cheatsheet
alias learnings_helper_cheatsheet learning_cheatsheet

ConsoleHelpers.register_helper("learning", LEARNING_HELPER_VERSION, method(:learning_cheatsheet))
